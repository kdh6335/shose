                        ...
                        <ul id="terms_ul">
                              <li id="terms_ul_li1">
                                    <span class="ul_li_span">
                                          ...
                                          CauseU 이용약관 동의<span class="span_only">(필수)</span>
                                          </label>
                                    </span>
                                    <div class="terms_box">
                                          <div class="article">
                                                <h3 class="article_title">제 1 조 (목적)</h3>
                                                <p>제 1 조 (목적) 이 약관은 CauseU 주식회사 ("회사" 또는 "CauseU")가 제공하는 CauseU <br>
                                                   및 CauseU 관련 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, <br>
                              ...
                              <li id="terms_ul_li2">
                                    ...
                                    <div class="terms_box">
                                          <div class="article">
                                                <p>정보통신망법 규정에 따라 CauseU에 회원가입 신청하시는 분께 수집하는<br>
                                                ...
                                                해 회원가입을 할 경우, CauseU는 서비스 이용을 위해 필요한 최소한의<br>
                                                 개인정보를 수집합니다.</p>
                                          </div>
                                    </div>
                              </li>
                                    ...
                                    <div class="terms_box">
                                          <div class="article">
                                                <p>위치정보 이용약관에 동의하시면, 위치를 활용한 광고 정보 수신 등을<br>
                                                 포함하는 위치기반 서비스를 이용할 수 있습니다.</p>
                                                
                                                <h3 class="article_title">제 1 조 (목적)</h3>
                                                <p>이 약관은 주식회사 (이하 “회사”)가 제공하는 위치정보사업 또는<br>
